...
const toolMetadata = [
    {
        ...
        description: "Inspect the workspace file tree without reading file contents. Use this first to orient inside an unfamiliar area before narrowing to specific files or symbols.",
    ...
    },
    {
        ...
        description: "List framework-detectable public routes, REST endpoints, and GraphQL resolvers in the workspace. Best for auditing the exposed route surface or locating likely entrypoints before deeper symbol or flow analysis.",
    ...
    },
    {
        ...
        description: "Locate symbol definitions in the workspace by name. This is the normal first step before code.trace_callers or code.trace_flow when you know the symbol but not its defining file.",
    ...
    },
    {
        ...
        title: "Search text",
        description: "Search text or regex patterns across the workspace with file, language, path, and context controls. Prefer this for textual usage discovery; prefer code.find_symbol plus trace tools for semantic symbol analysis.",
    ...
    },
    {
        ...
        description: "Trace downstream execution from a known workspace symbol to understand what it calls, what files it reaches, and how a feature flows before you modify logic. Resolve the symbol path with code.find_symbol first.",
    ...
    },
    {
        ...
        description: "Trace upstream callers of a known workspace symbol for impact analysis before changing, renaming, or removing shared code. Resolve the symbol path with code.find_symbol first; use recursive mode to expand the reverse call chain.",
