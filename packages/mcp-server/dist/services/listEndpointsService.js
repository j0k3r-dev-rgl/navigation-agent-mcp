            ...
            ? [
                {
                    ...
                    retryable: false,
                    suggestion: "Increase limit or narrow the path/language/framework filter. Use this tool to inventory likely public entrypoints, then switch to find_symbol or trace tools for deeper analysis.",
                    details: {
        ...
        errors: [
            {
                ...
                retryable: false,
                suggestion: "Correct the invalid fields and try again. Use framework and kind filters to describe the entrypoint surface you want to inventory.",
                details: { issues },
            },
        ],
            ...
            errors: [
                {
                    ...
                    message,
                    retryable,
                    suggestion: "Provide an existing file or directory path inside the workspace root, or omit the path filter to inventory endpoints across the whole workspace.",
                    details,
                },
            ],
            meta: createResponseMeta({ query }),
            ...
            errors: [
                {
                    ...
                    message,
                    retryable,
                    suggestion: "Use a path inside the workspace root or omit the path filter. This tool only inventories framework-detectable entrypoints inside the current workspace.",
                    details,
                },
            ],
            meta: createResponseMeta({ query }),
            ...
            errors: [
                {
                    ...
                    message,
                    retryable,
                    suggestion: "Verify the engine supports workspace.list_endpoints and retry. If you need a specific handler's logic or impact, continue with find_symbol, trace_callers, or trace_flow instead.",
                    details,
                },
            ],
            meta: createResponseMeta({ query }),
